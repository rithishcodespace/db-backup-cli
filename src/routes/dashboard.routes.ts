...
router.get('/backups', validateQuery(DashboardBackupsQuerySchema), (req, res) =>
  dashboardController.getBackups(req, res)
);
...
router.get('/logs', validateQuery(DashboardLogsQuerySchema), (req, res) =>
...
router.post('/backups/:id/cancel-waiting', validateParams(IdParamSchema), (req, res) =>
  dashboardController.cancelWaitingJob(req, res)
);
router.post('/trigger-backup', validateBody(TriggerBackupSchema), (req, res) =>
  dashboardController.triggerBackup(req, res)
);
