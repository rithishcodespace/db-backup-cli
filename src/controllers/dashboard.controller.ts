...
export class DashboardController {
  ...
  async getActiveBackups(_req: Request, res: Response): Promise<void> {
    try {
  ...
  async getQueues(_req: Request, res: Response): Promise<void> {
    try {
  ...
  async cancelWaitingJob(req: Request, res: Response): Promise<void> {
    try {
